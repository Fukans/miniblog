...
const file_apiserver_v1_apiserver_proto_rawDesc = "" +
	...
	"\x12\b/healthzB\x9b\x02\x92A\xe0\x01\x12\xb6\x01\n" +
	"\fminiblog API\"W\n" +
	"\x18小而美的博客项目\x12%https://github.com/onexstack/miniblog\x1a\x14colin404@foxmail.com*H\n" +
	"\vMIT License\x129https://github.com/onexstack/miniblog/blob/master/LICENSE2\x031.0*\x01\x022\x10application/json:\x10application/jsonZ5github.com/onexstack/miniblog/pkg/api/apiserver/v1;v1b\x06proto3"
